...
function eventsDe(user, uid){
  return [
    ...
    { eventType: "ADDED_TODO", userId: user._id, data: { todoId: uid + "1-2-1", labels:[], trackedTimes:[], title: "Drag and drop verwenden", position: 0, parentId: uid + "2-1" } },
...
function eventsEn(user, uid){
  return [
    ...
    { eventType: "ADDED_TODO", userId: user._id, data: { todoId: uid + "1-2-1", labels:[], trackedTimes:[], title: "Use drag and drop", position: 0, parentId: uid + "2-1" } },
    ...
    { eventType: "ADDED_TODO", userId: user._id, data: { todoId: uid + "4-2", labels:["#time"], trackedTimes:[], title: "Change time entry", position: 1, parentId: uid + "4" } },
    { eventType: "ADDED_TODO", userId: user._id, data: { todoId: uid + "4-3", labels:["#time"], trackedTimes:[], title: "See the tracked time via a script", position: 2, parentId: uid + "4" } },
